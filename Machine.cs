public abstract class Machine
{
    ...
    public virtual void SellEffect(Player player) { }
...
public abstract class FoodMachine
{
    ...
    public void AttackPet(FoodMachine machine)
    {
        this.ReceiveDamage(machine.Ataque);
        machine.ReceiveDamage(this.Ataque);
    }
    ...
    public void Union(FoodMachine machine)
    {
        if (this.GetType() != machine.GetType())
            throw new InvalidOperationException(
                "Você não pode juntar peças diferentes"
    ...
    public virtual void TurnEnd(Player player ) { }
    public virtual void AllySummonedEffect( ) { }
    public virtual void FoodEffect( ) { }
    public abstract FoodMachine Clone( );
}
